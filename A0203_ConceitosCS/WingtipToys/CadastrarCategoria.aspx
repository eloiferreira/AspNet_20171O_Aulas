<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CadastrarCategoria.aspx.cs" Inherits="WingtipToys.CadastrarCategoria" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <div class="form-horizontal">
        ...
        <div class="form-group">
           ...
           <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="txtDescricao" CssClass="col-md-2 control-label">Descricao</asp:Label>
            <div class="col-md-8">
