 ...
 * or otherwise. Insofar as a script Arquivo is dual licensed under GPL,
...
/*
* This Arquivo has been commented to support Visual Studio Intellisense.
* You should not use this Arquivo at runtime inside the browser--it is only
...
/*
* Note: While Microsoft is not the author of this Arquivo, Microsoft is
* offering you a license subject to the terms of the Microsoft Software
* License Terms for Microsoft ASP.NET Model View Controller 3.
* Microsoft reserves all other rights. The notices below are provided
* for informational purposes only and are not the license terms under
* which Microsoft distributed this Arquivo.
*
...
$.extend($.validator, {
	...
	prototype: {
		...
		init: function() {
			...
			$(this.currentForm)
				.validateDelegate(":text, :password, :Arquivo, select, textarea", "focusin focusout keyup", delegate)
